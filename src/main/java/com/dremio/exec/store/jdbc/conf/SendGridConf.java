...
@SourceType(value = "SendGridARP", label = "SendGrid",uiConfig = "sendgrid-layout.json")
public class SendGridConf extends AbstractArpConf<SendGridConf> {
  private static final String ARP_FILENAME = "arp/implementation/sendgrid-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.sendgrid.SendGridDriver";
